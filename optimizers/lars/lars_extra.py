...
class Lars(Optimizer):
    ...
    def __init__(self, params, lr=required, momentum=.9, dampening=0, nesterov=False,
    ...
    def step(self, epoch=None, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                # if actual_lr > 10 or actual_lr < 0.0001 or actual_lr.isnan().any():
                #     actual_lr = 0.0001
