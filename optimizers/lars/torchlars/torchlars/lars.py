...
from ._adaptive_lr import compute_adaptive_lr
...
class LARS(Optimizer):
    ...
    def __init__(self, optimizer, eps=1e-8, trust_coef=0.001, writer=None):
        if eps < 0.0:
    ...
    def __getstate__(self):
        ...
        lars_dict['trust_ratio'] = self.trust_coef
    ...
    def __setstate__(self, state):
        ...
        self.trust_coef = lars_dict['trust_ratio']
